...
fRegress <- function(y, xfdlist, betalist, wt=NULL, returnMatrix=FALSE)
  {
    UseMethod("fRegress")
  }
...
fRegress <- function(y, xfdlist, betalist, wt=NULL, returnMatrix=FALSE)
  ...
  #
  #  Returns FREGRESSLIST  ... A list with class name fRegress having members:
  ...
  #    df             ... degrees of freedom for fit
     # y2cMap         ... the matrix returned by function smooth.basis() that
     #                    maps noisy observed function values into the
     #                    coefficient matrix defining the smooth of the
     #                    noisy data.  Default is NULL.
     # SigmaE         ... The estimate of the standard error of the residuals
     #                    based on a previous analysis by function fRegress()
     # betastderrlist ... a list of length p containing estimated standard
     #                    error functions for the estimated regression
     #                    coefficient functions.
     # bvar           ... the variance-covariance matrix for the estimates
     #                    of coefficients defining the p regression functions.
     # c2bMap         ... the matrix mapping the Cmat into the master
     #                    coefficient vector bvec
